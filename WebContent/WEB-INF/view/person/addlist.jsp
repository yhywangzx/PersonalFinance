...
<meta content="IE=edge,chrome=1" http-equiv="X-UA-Compatible">
    ...
    <script src="lib/add.js" type="text/javascript"></script>
    <script type="text/javascript">
    	$(function(){
    		$("#classify").change(function(){
    			$.post("sortlist",{classify:$(this).val()},function(data){
    				var arr = eval('('+ data +')');
    				$("#subCategory").empty();
  ...
  <body class=""> 
  <!--<![endif]-->
     <form action="person/addlist" method="post"> 
     <div class="navbar">
    ...
    <div class="content">
        ...
        <div class="header">
            ...
            <h1 class="page-title">理财新增</h1>
        </div>
        
                <ul class="breadcrumb">
            <li><a href="person/users">首页</a> <span class="divider">/</span></li>
            <li class="active"><a href="person/users">新增列表</a><span class="divider">/</span></li>
            <li class="active">理财新增</li>
        </ul>
...
<div class="well">
    <ul class="nav nav-tabs">
      <li class="active"><a href="#home" data-toggle="tab">理财信息</a></li>
    </ul>
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
        ...
        <label>金额</label>
        <input type="text" name="money" class="input-xlarge">
		<label>列表</label>
		<select style="width: 166px" name ="classify" id="classify">
			<option value="收入"
			${ classify == "收入" ? "selected = 'selected'":"" }>收入</option>
			<option value="支出"
			${ classify == "支出" ? "selected = 'selected'":"" }>支出</option>
			
		</select>
		<select id="subCategory" name="cname">
